...
# indications: 1 for none, 2 for snoopylogger, 3 for message, 4 for both
indicationOption=$2
...
if [[ $indicationOption -eq 2 ]] || [[ $indicationOption -eq 4 ]]
then
...
if [[ $indicationOption -eq 3 ]] || [[ $indicationOption -eq 4 ]]
then
